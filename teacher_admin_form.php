...
<div class='layout layout--secondary'>
    <form class='form' method='POST' action='teacher_admin_sql.php'>
        <h2 class='subtitle'>Dodaj učitelja</h2>
...
echo "<br><br><a class='link--secondary' href='teacher_admin.php?id_ucitelja=$id_ucitelja'>&lt; povratak</a>";
