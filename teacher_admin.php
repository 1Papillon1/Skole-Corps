...
echo "<br><br><a class='layout__link layout__link--secondary'href='ucitelji.php'>Povratak</a>";
...
echo "<a class='' href='teacher_admin_form.php?id=" . $rezultati[0]["id_ucitelja"] . "'>Uredi</a>";

echo "<h2 class='subtitle'>O školama</h2>";
echo "<table><thead><tr><td>Škola</td> <td colspan='2'>Adresa</td> <td>Telefon</td> <td>Mail</td><td></td> </tr></thead>";
foreach($rezultati as $skola){
     
    echo "<tbody><tr class='table__row'><td>" . $skola["naziv_skole"] . 
    "</td><td colspan='2'>" . $skola["adresa_skole"] . 
    "</td><td>" . $skola["telefon"] . 
    "</td><td>" . $skola["mail_skole"] . 
    "</td><td>" . "<a class=''href='teacher_admin_skole_form.php?id_skole=" . $skola["id_skole"] . "'>Uredi</a>" .
    "</td></tr></tbody>";
